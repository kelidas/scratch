...
from scipy.stats import norm, uniform, weibull_min, lognorm, beta, gumbel_r, gumbel_l, fatiguelife
...
class PDistrib(HasTraits):
    ...
    distr_choice = Enum('sin2x', 'weibull_min', 'sin_distr', 'uniform', 'norm', 'lognorm', 'beta', 'gumbel_r', 'gumbel_l', 'fatiguelife')
