/* Generated by Cython 0.13 on Tue Nov  8 14:08:19 2011 */
...
/* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":31
...
static PyObject *__pyx_pf_7spirrid_loop_mu_q_e(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_t_12;
  int __pyx_t_13;
  __pyx_t_7spirrid_DTYPE_t __pyx_t_14;
  int __pyx_t_15;
  int __pyx_t_16;
  int __pyx_t_17;
  int __pyx_t_18;
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      ...
      if (likely(values[1])) kw_args--;
        ...
        __Pyx_RaiseArgtupleInvalid("loop_mu_q_e", 1, 7, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  2:
      values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__d_xi);
      if (likely(values[2])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("loop_mu_q_e", 1, 7, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  3:
      values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__Theta_la);
      if (likely(values[3])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("loop_mu_q_e", 1, 7, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  4:
      values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__Theta_xi);
      if (likely(values[4])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("loop_mu_q_e", 1, 7, 7, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  5:
      values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__g_la_pdf);
      if (likely(values[5])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("loop_mu_q_e", 1, 7, 7, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
      case  6:
      values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__g_xi_pdf);
      if (likely(values[6])) kw_args--;
      else {
        __Pyx_RaiseArgtupleInvalid("loop_mu_q_e", 1, 7, 7, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    }
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "loop_mu_q_e") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    __pyx_v_e_arr = ((PyArrayObject *)values[0]);
    __pyx_v_d_la = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_d_la == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_d_xi = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_d_xi == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    ...
    __pyx_v_d_la = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 1)); if (unlikely((__pyx_v_d_la == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_d_xi = __pyx_PyFloat_AsDouble(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_d_xi == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  ...
  __Pyx_RaiseArgtupleInvalid("loop_mu_q_e", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_e_arr), __pyx_ptype_5numpy_ndarray, 1, "e_arr", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_Theta_la), __pyx_ptype_5numpy_ndarray, 1, "Theta_la", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_Theta_xi), __pyx_ptype_5numpy_ndarray, 1, "Theta_xi", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_g_la_pdf), __pyx_ptype_5numpy_ndarray, 1, "g_la_pdf", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_g_xi_pdf), __pyx_ptype_5numpy_ndarray, 1, "g_xi_pdf", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_e_arr, (PyObject*)__pyx_v_e_arr, &__Pyx_TypeInfo_nn___pyx_t_7spirrid_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_e_arr = __pyx_bstruct_e_arr.strides[0];
  __pyx_bshape_0_e_arr = __pyx_bstruct_e_arr.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_Theta_la, (PyObject*)__pyx_v_Theta_la, &__Pyx_TypeInfo_nn___pyx_t_7spirrid_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_Theta_la = __pyx_bstruct_Theta_la.strides[0];
  __pyx_bshape_0_Theta_la = __pyx_bstruct_Theta_la.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_Theta_xi, (PyObject*)__pyx_v_Theta_xi, &__Pyx_TypeInfo_nn___pyx_t_7spirrid_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_Theta_xi = __pyx_bstruct_Theta_xi.strides[0];
  __pyx_bshape_0_Theta_xi = __pyx_bstruct_Theta_xi.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_g_la_pdf, (PyObject*)__pyx_v_g_la_pdf, &__Pyx_TypeInfo_nn___pyx_t_7spirrid_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_g_la_pdf = __pyx_bstruct_g_la_pdf.strides[0];
  __pyx_bshape_0_g_la_pdf = __pyx_bstruct_g_la_pdf.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_g_xi_pdf, (PyObject*)__pyx_v_g_xi_pdf, &__Pyx_TypeInfo_nn___pyx_t_7spirrid_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_g_xi_pdf = __pyx_bstruct_g_xi_pdf.strides[0];
  __pyx_bshape_0_g_xi_pdf = __pyx_bstruct_g_xi_pdf.shape[0];

  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":34
 *     # loop over the control variable (strain)
 *     # define an array of the same size as e_arr
 ...
 */
  ...
  __pyx_v_mu_q_arr = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":37
 *     cdef int i, la, xi
 *     cdef double mu_q_e, dG, e, eps_, q
 ...
 */
  __pyx_t_4 = 0;
  if (PyList_CheckExact(((PyObject *)__pyx_v_e_arr)) || PyTuple_CheckExact(((PyObject *)__pyx_v_e_arr))) {
    __pyx_t_5 = 0; __pyx_t_3 = ((PyObject *)__pyx_v_e_arr); __Pyx_INCREF(__pyx_t_3);
  } else {
    __pyx_t_5 = -1; __pyx_t_3 = PyObject_GetIter(((PyObject *)__pyx_v_e_arr)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 37; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
  }
  for (;;) {
    ...
    /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":38
 *     cdef double mu_q_e, dG, e, eps_, q
 *     for i, e in enumerate(e_arr):
 *         mu_q_e = 0.0             # <<<<<<<<<<<<<<
 *         for la in range(len(Theta_la)): # loop over lambda range (array of values)
 ...
 */
    ...
    /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":39
 *     for i, e in enumerate(e_arr):
 *         mu_q_e = 0.0
 *         for la in range(len(Theta_la)): # loop over lambda range (array of values)             # <<<<<<<<<<<<<<
 *             for xi in range(len(Theta_xi)): # loop over xi range (array of values)
 ...
 */
    __pyx_t_7 = PyObject_Length(((PyObject *)__pyx_v_Theta_la)); if (unlikely(__pyx_t_7 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      __pyx_v_la = __pyx_t_8;

      /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":40
 *         mu_q_e = 0.0
 *         for la in range(len(Theta_la)): # loop over lambda range (array of values)
 *             for xi in range(len(Theta_xi)): # loop over xi range (array of values)             # <<<<<<<<<<<<<<
 *                 dG = g_la_pdf[la] * g_xi_pdf[xi] * d_la * d_xi
 *                 q = e / ( 1.0 + Theta_la[la] )
 */
      __pyx_t_9 = PyObject_Length(((PyObject *)__pyx_v_Theta_xi)); if (unlikely(__pyx_t_9 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        __pyx_v_xi = __pyx_t_10;

        /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":41
 *         for la in range(len(Theta_la)): # loop over lambda range (array of values)
 *             for xi in range(len(Theta_xi)): # loop over xi range (array of values)
 *                 dG = g_la_pdf[la] * g_xi_pdf[xi] * d_la * d_xi             # <<<<<<<<<<<<<<
 *                 q = e / ( 1.0 + Theta_la[la] )
 ...
 */
        ...
        __pyx_v_dG = ((((*__Pyx_BufPtrStrided1d(__pyx_t_7spirrid_DTYPE_t *, __pyx_bstruct_g_la_pdf.buf, __pyx_t_11, __pyx_bstride_0_g_la_pdf)) * (*__Pyx_BufPtrStrided1d(__pyx_t_7spirrid_DTYPE_t *, __pyx_bstruct_g_xi_pdf.buf, __pyx_t_12, __pyx_bstride_0_g_xi_pdf))) * __pyx_v_d_la) * __pyx_v_d_xi);

        /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":42
 *             for xi in range(len(Theta_xi)): # loop over xi range (array of values)
 *                 dG = g_la_pdf[la] * g_xi_pdf[xi] * d_la * d_xi
 *                 q = e / ( 1.0 + Theta_la[la] )             # <<<<<<<<<<<<<<
 *                 eps_ = Theta_xi[xi] - q
 ...
 */
        ...
        __pyx_t_14 = (1.0 + (*__Pyx_BufPtrStrided1d(__pyx_t_7spirrid_DTYPE_t *, __pyx_bstruct_Theta_la.buf, __pyx_t_13, __pyx_bstride_0_Theta_la)));
        if (unlikely(__pyx_t_14 == 0)) {
          PyErr_Format(PyExc_ZeroDivisionError, "float division");
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        __pyx_v_q = (__pyx_v_e / __pyx_t_14);

        /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":43
 *                 dG = g_la_pdf[la] * g_xi_pdf[xi] * d_la * d_xi
 *                 q = e / ( 1.0 + Theta_la[la] )
 *                 eps_ = Theta_xi[xi] - q             # <<<<<<<<<<<<<<
 *                 if eps_ < 0.0 or eps_ > Theta_xi[xi]:
 ...
 */
        ...
        __pyx_v_eps_ = ((*__Pyx_BufPtrStrided1d(__pyx_t_7spirrid_DTYPE_t *, __pyx_bstruct_Theta_xi.buf, __pyx_t_15, __pyx_bstride_0_Theta_xi)) - __pyx_v_q);

        /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":44
 *                 q = e / ( 1.0 + Theta_la[la] )
 *                 eps_ = Theta_xi[xi] - q
 *                 if eps_ < 0.0 or eps_ > Theta_xi[xi]:             # <<<<<<<<<<<<<<
 *                     q = 0.0
 *                 mu_q_e += q * dG
 */
        __pyx_t_16 = (__pyx_v_eps_ < 0.0);
        if (!__pyx_t_16) {
          __pyx_t_17 = __pyx_v_xi;
          __pyx_t_18 = (__pyx_v_eps_ > (*__Pyx_BufPtrStrided1d(__pyx_t_7spirrid_DTYPE_t *, __pyx_bstruct_Theta_xi.buf, __pyx_t_17, __pyx_bstride_0_Theta_xi)));
        ...
        if (__pyx_t_19) {
          ...
          /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":45
 *                 eps_ = Theta_xi[xi] - q
 *                 if eps_ < 0.0 or eps_ > Theta_xi[xi]:
 *                     q = 0.0             # <<<<<<<<<<<<<<
 *                 mu_q_e += q * dG
 ...
 */
        ...
        /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":46
 *                 if eps_ < 0.0 or eps_ > Theta_xi[xi]:
 *                     q = 0.0
 *                 mu_q_e += q * dG             # <<<<<<<<<<<<<<
 *         mu_q_arr[ i ] = mu_q_e
 ...
 */
    ...
    /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":47
 *                     q = 0.0
 *                 mu_q_e += q * dG
 *         mu_q_arr[ i ] = mu_q_e             # <<<<<<<<<<<<<<
 *     return mu_q_arr
 * 
 */
    __pyx_t_1 = PyFloat_FromDouble(__pyx_v_mu_q_e); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    if (__Pyx_SetItemInt(((PyObject *)__pyx_v_mu_q_arr), __pyx_v_i, __pyx_t_1, sizeof(int), PyInt_FromLong) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 47; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":48
 *                 mu_q_e += q * dG
 *         mu_q_arr[ i ] = mu_q_e
 *     return mu_q_arr             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/rch/workspace/simvisage/src/apps/scratch/kelidas/cython/cython_vs_c/cython.pyx":11
