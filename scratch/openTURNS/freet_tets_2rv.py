...
formulas[0] = "8 - (8 * exp(-(x1^2 + x2^2)) + 2 * exp(-((x1-5)^2 + (x2-4)^2)) + 1 + x1*x2/10.)"
...
pdfgraph2.draw("freet_prob/x2", 640, 480)
# Visualize the graph
