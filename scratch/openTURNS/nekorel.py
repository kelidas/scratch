...
# If the dimensions are omitted, the default is 400x300 up to release 0.10.0, 
# and 640x480 for the later releases
pdfgraph2.draw( "nekorel/x2", 640, 480 )
# Visualize the graph
#ViewImage( pdfgraph1.getBitmap() )
# Fill the first marginal of aCollection
aCollection.add( Distribution( marginal, "x2" ) )

# Create a third marginal : LogNormal distribution 1D, parameterized by its 
# mean and standard deviation
marginal = LogNormal( mean[2], sigma[2], BorneInf, LogNormal.MUSIGMA )
marginal.setName( "marginal x3" )
component[0] = "x3"
marginal.setDescription( component )
# Graphical output of the PDF
...
# If the dimensions are omitted, the default is 400x300 up to release 0.10.0, 
# and 640x480 for the later releases
pdfgraph3.draw( "nekorel/x3", 640, 480 )
# Visualize the graph
#ViewImage( pdfgraph1.getBitmap() )
# Fill the first marginal of aCollection
...
marginal.setName( "marginal x4" )
component[0] = "x4"
marginal.setDescription( component )
# Graphical output of the PDF
pdfgraph4 = marginal.drawPDF()
pdfgraph4.draw( "nekorel/x4", 640, 480 )
