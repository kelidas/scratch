...
try :
  ...
  myAlgorithm.run()
  print "minimizer = ", printNumericalPoint(BoundConstrainedAlgorithm(myAlgorithm).getResult().getOptimizer(), 4), " value=%.5e" %BoundConstrainedAlgorithm(myAlgorithm).getResult().getOptimalValue()
  ...
  myAlgorithm.run()
  print "maximizer = ", printNumericalPoint(BoundConstrainedAlgorithm(myAlgorithm).getResult().getOptimizer(), 4), " value=%.5e" % BoundConstrainedAlgorithm(myAlgorithm).getResult().getOptimalValue()
