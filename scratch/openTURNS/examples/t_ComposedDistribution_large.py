...
# Create a collection of distribution
    ...
    aCollection = DistributionCollection(dimension, Distribution(Normal(meanPoint, sigma, R)))
    for i in range(dimension) :
        aCollection[i] = Distribution(Normal(meanPoint, sigma, R))
...
# Instanciate one distribution object
    ...
    sample = margins.getNumericalSample(1000)
