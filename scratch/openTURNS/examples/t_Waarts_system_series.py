...
try :
  ...
  myAlgoAR = FORM(NearestPointAlgorithm(myAbdoRackwitz), myEvent, start+NumericalPoint(2,1))
  myAlgoAR2 = SORM(NearestPointAlgorithm(myAbdoRackwitz), myEvent, start+NumericalPoint(2,1))
