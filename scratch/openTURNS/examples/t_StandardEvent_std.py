...
try :
    ...
    print "myStandardEvent sample=" , repr(myStandardEvent.getNumericalSample(10))
    ...
    print "Failure probability (Event)=%.6f" % myEvent.getNumericalSample(size).computeMean()[0]
    print "Failure probability (StandardEvent)=%.6f" % stdEvent.getNumericalSample(size).computeMean()[0]
