...
#                                 theta = 0.01, xi = 0.0179, phi = 1., n_f = 1723 )
    ...
    def _clear_fired( self ):
        ...
        axes.clear()
        data1 = loadtxt( '1_ed.txt', delimiter = ';', dtype = 'float' )
        data2 = loadtxt( '2_ed.txt', delimiter = ';', dtype = 'float' )
        data3 = loadtxt( '3_ed.txt', delimiter = ';', dtype = 'float' )
        data4 = loadtxt( '4_ed.txt', delimiter = ';', dtype = 'float' )
        axes.plot( data1[:, 0] / 1000., data1[:, 1] )
        axes.plot( data2[:, 0] / 1000., data2[:, 1] )
        axes.plot( data3[:, 0] / 1000., data3[:, 1] )
        axes.plot( data4[:, 0] / 1000., data4[:, 1] )
