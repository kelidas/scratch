...
class MarcPlanteQuadratic2D(pythonequations.EquationBaseClasses.Equation2D):
    ...
    def SpecificCodeCPP(self):
        s = "\ttemp += ((-1.0 * " + self.coefficientDesignatorTuple[1] + ") + pow((" + self.coefficientDesignatorTuple[1] + " * " + self.coefficientDesignatorTuple[1] + ") - 4.0 * " + self.coefficientDesignatorTuple[0]  + " * (" + self.coefficientDesignatorTuple[2] + " - x_in), 0.5)) / 2.0 / " + self.coefficientDesignatorTuple[1] + ";\n"
        return s
