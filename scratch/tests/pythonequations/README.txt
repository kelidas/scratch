Version info: $Id: README.txt 231 2010-07-02 00:12:21Z zunzun.com $ 

You will need to install python, numpy and scipy to
run this software.

See the Examples directory to get started, all of the
examples should run by using "python examplename.py"
at a command prompt. 
