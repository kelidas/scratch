...
from traits.api \
    import HasTraits, Int, Button, Float
...
#        a = Thread( target=self.counter,
#                    args=( 'thread_0', ( 0 * 10 + 10 ) / 1000.0 ) )
#        b = Thread( target=self.counter,
#                    args=( 'thread_1', ( 1 * 10 + 10 ) / 1000.0 ) )
#        c = Thread( target=self.counter,
#                    args=( 'thread_2', ( 2 * 10 + 10 ) / 1000.0 ) )
#        b.start()
#        c.start()
#        a.start()
