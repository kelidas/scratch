...
class LView(HasTraits):
    ...
    plot2dview = Instance(Plot2DView)

    def _dataview_changed(self):
        return self.dataview.lorenz.refresh()
...
test = LView(dataview=DataView(lorenz=Lorenz()), plot2dview=Plot2DView(lorenz=Lorenz()))
